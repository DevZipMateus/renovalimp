        ...
        <div className="max-w-4xl mx-auto pt-16">
          <div ref={el => elementsRef.current[0] = el} className="mb-8 opacity-0 flex justify-center">
            <img 
              ...
              src="/lovable-uploads/df6d1330-bd35-4252-a668-39a6f0cb6e5d.png" 
            />
          </div>
          ...
          <div 
            ...
            className="flex flex-col sm:flex-row justify-center gap-4 mb-6 opacity-0" 
          ...
          >
            <button
              ...
              className="bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white px-6 py-3 rounded-md font-medium transition-all duration-300 transform hover:scale-105 flex items-center gap-2 shadow-lg"
            >
              <Instagram size={20} />
